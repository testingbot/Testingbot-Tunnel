...
public final class HttpProxy {
    ...
    public void start() {
        try {
            ...
            Logger.getLogger(App.class.getName()).log(Level.SEVERE, "Could not set up local http proxy. Please make sure this program can open port {0} on this computer.", app.getJettyPort());
            System.exit(1);
        }
    }
